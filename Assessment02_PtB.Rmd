...
# RMSE
swVIF_RMSE = sqrt(mean((prediction - df_selected_test$BTC.USD.Close)^2, na.rm = TRUE))/(mean(df_selected_test$BTC.USD.Close)) * 100
swVIF_RMSE
```
...
# RMSE
Lasso_RMSE = sqrt(mean((y_predicted - y2)^2, na.rm = TRUE))/(mean(y2)) * 100
Lasso_RMSE
```