...
```{r stepwise_caret}
library(caret)
train.control <- trainControl(method = "cv", number = 20, p = 0.7)
# use the data without volume
step.model <- train(BTC.USD.Close ~.,
                    data = na.omit(subset(df_selected,
                                         select=-c(date,
                                                   BTC_TDlag_1,
                                                   BTC_TDlag_5,
                                                   BTC_TDlag_10,
                                                   ...
                                                   BTC_TDlag_40,
                                                   BTC_TDlag_60,
ETH.USD.Close,IXIC.Close,GC.F.Close,TSM.Close
                                                   )
                                         )
                                 ),
